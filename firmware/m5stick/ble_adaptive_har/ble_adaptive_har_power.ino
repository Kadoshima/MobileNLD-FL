...
void setup() {
    ...
    Serial.begin(115200);
    Serial.println("BLE Adaptive HAR with Power Monitoring");
...
void updateControlState() {
    ...
    if (new_state != control_state) {
        ...
        Serial.printf("Control state changed to %s, interval=%dms\n",
...
void logPowerData() {
    ...
    if (!csv_header_printed) {
        Serial.println("timestamp_ms,control_state,har_state,uncertainty,adv_interval_ms,voltage_V,current_mA,power_mW,battery_pct,packets_sent");
        csv_header_printed = true;
    }
    
    // Log data
    Serial.printf("%lu,%d,%d,%.3f,%d,%.3f,%.2f,%.2f,%d,%d\n",
        millis(),
        control_state,
        har_state,
